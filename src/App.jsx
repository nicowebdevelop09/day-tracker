...
function loadData() {
  try {
    ...
    if (!raw) return { entries: {}, reminders: [], hiddenBase: [], customCategories: [] };
    const parsed = JSON.parse(raw);
    return { entries: {}, reminders: [], hiddenBase: [], customCategories: [], ...parsed };
  } catch {
    return { entries: {}, reminders: [], hiddenBase: [], customCategories: [] };
  }
}
